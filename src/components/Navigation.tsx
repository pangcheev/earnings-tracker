...
export function Navigation({ currentPage, onPageChange, onLogout, isAdmin, onAdminClick, currentUserEmail, currentUserFirstName, currentUserLastName, onChangePasswordClick }: NavigationProps) {
  return (
