...
export function Navigation({ activeLocation, setActiveLocation, currentPage, onPageChange, onLogout, isAdmin, onAdminClick }: NavigationProps) {
  return (
